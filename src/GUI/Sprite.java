...
public class Sprite{
    ...
    private boolean animated = false;   //Indica si la imagen de objeto es animada
    private boolean destroyAfterAnim = false;

    private Timer timer;
    private int animationSpeed;
    private double xPos, yPos;  //Posiciones, manipuladas por el servidor
    ...
    public void setAnimated(boolean animated, boolean destroyAfterAnim){
        if(loop){
            loop = false;
        }
    ...
    public void setDestroyAfterAnim(boolean destoryAfterAnim) {
        this.destroyAfterAnim = destoryAfterAnim;
    }
